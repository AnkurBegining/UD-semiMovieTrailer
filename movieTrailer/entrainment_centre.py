...
from movieTrailer import fresh_tomatoes

the_shawshank = media.Movie("The Shawshank Redemption",
                            "the film tells the story of Andy Dufresne, "
...
The_Last_Samurai = media.Movie("The Last Samurai",
                               ...
                               " of the United States 7th Cavalry Regiment, whose personal and emotional "
                               "conflicts bring him into contact with samurai warriors in the wake of the "
                               "Meiji Restoration in 19th Century Japan.",
                               "https://upload.wikimedia.org/wikipedia/en/c/c6/The_Last_Samurai.jpg",
                               "https://www.youtube.com/watch?v=RdS6FgmO4j8")

ms_dhoni = media.Movie("Ms Dhoni", "Untold story of India's most successful captain of cricket team",
...
vanilla_sky = media.Movie("Vanilla Sky", "About a mightnight in Paris",
                          "https://upload.wikimedia.org/wikipedia/en/9/9b/Vanilla_sky_post.jpg",
                          "https://www.youtube.com/watch?v=k09OX40NLUw&t=27s")

yah_jawani_hai_dewani = media.Movie("Yah Jawani Hai Diwani", "Story of four friend",
                                    "https://upload.wikimedia.org/wikipedia/en/1/15/Yeh_jawani_hai_deewani.jpg",
                                    "https://www.youtube.com/watch?v=Rbp2XUSeUNE")

movies = [ms_dhoni, avatar, The_Last_Samurai, the_shawshank, vanilla_sky, yah_jawani_hai_dewani]
